...
export const CHARACTERS: Character[] = [
  ...
  { id: "lambchop_yampot", name: "Lamb Chop Yam-pot", country: "Spain", number: 19, primary: "#aa151b", secondary: "#f1bf00", shorts: "#1f3c88", skin: "#d59a6a", hair: "#24160f" },
  ...
  { id: "floorcleaner_hurts", name: "Floor-cleaner Hurts", country: "Germany", number: 17, primary: "#ffffff", secondary: "#111111", shorts: "#111111", skin: "#d3a071", hair: "#5f3a21" },
  ...
  { id: "fedora_vaultverde", name: "Fedora Vault-verde", country: "Uruguay", number: 8, primary: "#7bcdf2", secondary: "#111111", shorts: "#111111", skin: "#e0a677", hair: "#4c2b18" },
  ...
  { id: "william_saliva", name: "William Saliva", country: "France", number: 17, primary: "#244ecf", secondary: "#ffffff", shorts: "#d22b2b", skin: "#8a5a3b", hair: "#15100d" },
